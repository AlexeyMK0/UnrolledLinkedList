...
void ClearCounters() {
    ...
    SomeObj3::CopiesCount = 0;
    SomeObj3::DestructorCalled = 0;
}
...
TEST_F(ExceptionSafetyTest, failesAtInsert) {
    ClearCounters();
    SomeObj3::DestructorCalled = 0;
    TestAllocator<SomeObj3> allocator;
    unrolled_list<SomeObj3, 16, TestAllocator<SomeObj3>> ui;
    ASSERT_ANY_THROW(
        ui.insert(ui.begin(), 10, SomeObj3{});
    );
